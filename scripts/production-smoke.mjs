...
const protectedPages = [
  ...
  { path: "/en/app/announcements", expectedLocation: "/en/login" },
  { path: "/en/app/certificates", expectedLocation: "/en/login" },
  { path: "/en/app/lessons", expectedLocation: "/en/login" },
  { path: "/en/app/notes", expectedLocation: "/en/login" },
  { path: "/en/app/notifications", expectedLocation: "/en/login" },
  { path: "/en/app/pre-arrival", expectedLocation: "/en/login" },
  { path: "/en/app/profile", expectedLocation: "/en/login" },
  { path: "/en/app/progress", expectedLocation: "/en/login" },
  { path: "/en/app/reviews", expectedLocation: "/en/login" },
  { path: "/en/app/schedule", expectedLocation: "/en/login" },
  { path: "/en/app/support", expectedLocation: "/en/login" },
  { path: "/en/app/teacher/dashboard", expectedLocation: "/en/staff/login" },
  { path: "/en/admin", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/abandoned", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/analytics", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/announcements", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/audit", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/batches", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/blog", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/calendar", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/communications", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/coupons", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/courses", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/dashboard", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/enrollments", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/faq", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/finance", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/gallery", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/leads", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/notifications", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/overview", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/resources", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/settings", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/social-proof", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/staff", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/students", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/templates", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/testimonials", expectedLocation: "/en/admin/login" },
  { path: "/en/admin/waitlist", expectedLocation: "/en/admin/login" },
...
const protectedApis = [
  ...
  "/api/admin/payments/payment_smoke",
  "/api/admin/prearrival-resources",
  "/api/admin/provider-smoke",
  "/api/admin/settings",
  "/api/admin/social-proof",
  "/api/admin/staff",
  "/api/admin/students/access",
  "/api/admin/templates",
  "/api/admin/testimonials",
  "/api/admin/waitlist",
  "/api/app/announcements",
  "/api/app/modules/module_smoke",
  "/api/app/notes",
  "/api/app/notifications",
  "/api/app/portal",
  "/api/app/profile",
  "/api/app/resources/resource_smoke",
  "/api/app/support",
  "/api/app/tasks/task_smoke",
  "/api/app/testimonials",
  "/api/certificates",
  "/api/certificates/certificate_smoke/download",
