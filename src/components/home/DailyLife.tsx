...
export const DailyLife = () => {
  ...
  return (
    <section id="daily-life" className="relative overflow-hidden border-y border-stone-100 bg-white py-12 md:py-16">
      <div className="container-edit relative z-10 mb-8 md:mb-10 flex items-end justify-between">
        <SectionHeading
        ...
        <div className="hidden gap-2 md:flex">
          <button
            onClick={() => scroll("left")}
            className="rounded-full border border-stone-200 p-3 hover:bg-stone-50"
            aria-label="Previous"
          >
      ...
      <div className="container-wide relative z-10">
        <div
          ref={scrollRef}
          className="-mx-4 flex snap-x snap-proximity gap-4 overflow-x-auto overscroll-y-auto px-4 pb-5 [scrollbar-width:none] [touch-action:pan-x_pan-y] md:gap-5 md:px-0 md:mx-0 [&::-webkit-scrollbar]:hidden"
        >
          {DAILY_LIFE.map((d, i) => (
