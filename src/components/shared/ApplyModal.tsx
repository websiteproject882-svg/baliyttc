                      ...
                      <div className="space-y-3">
                        ...
                        {!hasAvailablePaymentProvider && (
                          <div className="rounded-xl border border-red-100 bg-red-50 p-4 space-y-3">
                            <p className="text-sm text-red-700 font-medium">No online payment method is currently available for your region.</p>
                            <p className="text-xs text-red-600">Please contact us directly on WhatsApp — we will arrange payment manually.</p>
                            <a
                              href={`https://wa.me/628213574379?text=${encodeURIComponent("Hi, I'd like to enroll in a Bali YTTC yoga teacher training program. I need help with payment as online options are unavailable for me.")}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center justify-center gap-2 w-full rounded-lg bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#1ebe5d] transition-colors"
                            >
                        ...
                        {/* Special section — always visible, specially for Russian users or anyone with payment issues */}
                        <div className="rounded-xl border border-[#25D366]/40 bg-[#f0fdf4] p-4 space-y-2">
                          <p className="text-xs font-semibold text-gray-700 uppercase tracking-wide">🇷🇺 For Russian users — specially for you</p>
                          <p className="text-xs text-gray-600">If online payment methods are not working for you, contact us directly on WhatsApp. We will personally help you arrange payment.</p>
                          <p className="text-xs text-gray-500 italic">Если вам недоступна онлайн-оплата, напишите нам в WhatsApp — мы поможем.</p>
                          <a
                            href={`https://wa.me/628213574379?text=${encodeURIComponent("Здравствуйте! Я из России и хочу записаться на курс Bali YTTC. Мне нужна помощь с оплатой.")}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center gap-2 w-full rounded-lg bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#1ebe5d] transition-colors"
                          >
