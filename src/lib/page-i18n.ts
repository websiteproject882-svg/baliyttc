...
const en = {
  ...
  pageHero: {
    ...
    backHome: "Back to Home",
    applyNow: "Apply Now",
    applyFrom: "Apply from EUR {price}",
    workshopsEyebrow: "Workshops & Experiences",
    workshopsTitle: "Go Deeper.",
    workshopsAccent: "Play Wider.",
    workshopsIntro: "Standalone workshops for students who want a focused Bali experience with senior teachers.",
    bookWorkshop: "Book a Workshop",
    viewWorkshops: "View All Workshops",
    retreatsEyebrow: "Yoga Retreats in Bali",
    retreatsTitle: "Retreat. Restore.",
    retreatsAccent: "Revitalise.",
    retreatsIntro: "Escape to Bali for a transformative retreat in Ubud or by the ocean.",
    bookRetreat: "Book Your Retreat",
    viewRetreats: "View All Retreats",
    blogEyebrow: "Our Journal",
    blogTitle: "Yoga",
    blogAccent: "Guides & Insights",
    blogIntro: "Training notes, certification explainers and practice guidance from Bali YTTC.",
    termsTitle: "Terms &",
    termsAccent: "Policy",
  },
};
...
const es = {
  ...
  pageHero: {
    ...
    applyFrom: "Aplicar desde EUR {price}",
    workshopsEyebrow: "Talleres y experiencias",
    workshopsTitle: "Profundiza.",
    workshopsAccent: "Explora más.",
    workshopsIntro: "Talleres independientes para estudiantes que quieren una experiencia enfocada en Bali con profesores senior.",
    bookWorkshop: "Reservar taller",
    viewWorkshops: "Ver talleres",
    retreatsEyebrow: "Retiros de yoga en Bali",
    retreatsTitle: "Retírate. Restaura.",
    retreatsAccent: "Revitaliza.",
    retreatsIntro: "Escápate a Bali para un retiro transformador en Ubud o junto al océano.",
    bookRetreat: "Reservar retiro",
    viewRetreats: "Ver retiros",
    blogEyebrow: "Nuestro diario",
    blogTitle: "Guías e ideas",
    blogAccent: "de yoga",
    blogIntro: "Notas de formación, certificación y práctica desde Bali YTTC.",
    termsTitle: "Términos y",
    termsAccent: "política",
  },
};
